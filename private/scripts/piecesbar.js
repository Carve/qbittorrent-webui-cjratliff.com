    ...
    const PiecesBar = new Class({
        initialize(pieces, parameters) {
            const vals = {
                ...
                "width": 0,
                "height": 0,
                "downloadingColor": "#00d9ff", // @TODO palette vars not supported for this value, apply average
                "haveColor": "#00d9ff", // @TODO palette vars not supported for this value, apply average
                "borderSize": 1,
